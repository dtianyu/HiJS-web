...
var CateDetailController = ['$scope', '$routeParams', '$location', 'Cate', 'Cart', 'Filter', function ($scope, $routeParams, $location, Cate, Cart, Filter) {
...
var FreshDetailController = ['$scope', '$routeParams', '$location', 'Fresh', 'Cart', 'Filter', function ($scope, $routeParams, $location, Fresh, Cart, Filter) {
...
var HelpDetailController = ['$scope', '$routeParams', '$location', 'Help', 'Cart', 'Filter', function ($scope, $routeParams, $location, Help, Cart, Filter) {
...
var TrainingDetailController = ['$scope', '$routeParams', '$location', 'Training', 'Cart', 'Filter', function ($scope, $routeParams, $location, Training, Cart, Filter) {
